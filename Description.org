...
- I now have to make for the filters F515, F660, F861.

* Finding for new SMC PNe

** Applying the colour criterio:
 *** Given is a very large catalog MC.catalog ~ 4 G. It s necesary used database sqlite3. 
  + Creating sqlite databe:
